...
insert into timeOfNameInHouseParticularOption (id, code, title, score, criteria_no)
    values
...
update timeOfNameInHouseParticularOption set code = '1', title = 'ต่ำกว่า 1 ปี', score = 1, criteria_no = 1 where id = 2;
update timeOfNameInHouseParticularOption set code = '2', title = 'ระหว่าง 1-2 ปี', score = 1, criteria_no = 1 where id = 3;
update timeOfNameInHouseParticularOption set code = '3', title = 'ระหว่าง 2-4 ปี', score = 2, criteria_no = 1 where id = 4;
update timeOfNameInHouseParticularOption set code = '4', title = 'ระหว่าง 4-6 ปี', score = 3, criteria_no = 1 where id = 5;
update timeOfNameInHouseParticularOption set code = '5', title = 'ระหว่าง 6-7 ปี', score = 3, criteria_no = 1 where id = 6;
...
/*
 id |                     title
----+-----------------------------------------------
  1 | --กรุณาระบุระยะเวลาที่ท่านอยู่อาศัยในทะเบียนบ้านปัจจุบัน--
  2 | ต่ำกว่า 1 ปี
  3 | 2-4 ปี
  4 | 4-6 ปี
  5 | 7-8 ปี
...
insert into incomeTrendOption (id, code, title, score, criteria_no)
    values
        (1, '0', '--กรุณาประเมินแนวโน้มเศรษฐกิจที่มีผลต่อรายได้ของท่าน--', 1, 5),
        (2, '1', 'รายได้ลดลงมากกว่า 10%/ปี', 1, 5),
        (3, '2', 'รายได้ลดลง 1-9%/ปี', 2, 5),
        (4, '3', 'รายได้คงเดิม', 3, 5),
        (5, '4', 'รายได้เพิ่มขึ้น 1-9%/ปี', 4, 5),
        (6, '5', 'รายได้เพิ่มขึ้น 10%ขึ้นไป/ปี', 5, 5);
...
--#########
create table forgotPasswordQuestionOption (
    id int generated by default as identity,
    title varchar not null,
    primary key (id)
);

insert into forgotPasswordQuestionOption
    (title)
    values ('อาหารที่คุณชอบคือ?'), ('ชื่อสัตว์เลี้ยงที่คุณชื่นชอบ?'), ('สถานที่คุณชื่นชอบ?');


alter table users add column forgotPasswordQuestionID int;

ALTER TABLE users
    ADD CONSTRAINT sers_forgotPassowordQuestionID_fk
    FOREIGN KEY (forgotPasswordQuestionID) REFERENCES forgotPasswordQuestionOption (id);

alter table users add column forgotPasswordAns varchar;

update users set forgotPasswordAns = '';
